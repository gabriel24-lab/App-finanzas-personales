            ...
            {[
              ...
              >
                <div>
                  ...
                  <p className="text-[11px] text-neutral-400">{row.cat}</p>
                </div>
                <span
      ...
      <div className="relative overflow-hidden bg-brand-950">
        ...
        <section className="relative z-10 mx-auto max-w-3xl px-4 pb-24 pt-14 text-center sm:px-6 sm:pb-32 sm:pt-16 lg:px-8">
          ...
          <motion.p
            ...
            className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-neutral-300 sm:text-lg"
          >
          ...
          <motion.p
            ...
            className="mt-5 text-xs font-medium text-neutral-400"
          >
            {t("landing.hero.note")}
          </motion.p>
        </section>
