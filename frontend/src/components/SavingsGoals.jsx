          ...
          (addingFunds ? (
            <form onSubmit={handleAdd} className="flex items-center gap-1.5">
              <input
                ...
                placeholder="Monto"
                className="w-20 rounded-lg border border-neutral-200 px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-900"
              />
              <button
                type="submit"
                className="rounded-lg bg-neutral-900 px-2 py-1 text-[11px] font-semibold text-white cursor-pointer"
              >
                Añadir
              </button>
              <button
